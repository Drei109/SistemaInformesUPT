...
//        definirTituloTabla(nivelUsuario);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTA INFORMES");
...
//        }
        ...
        if (tblBuscar.getSelectedRow() >= 0) {
            if (cmbTipoInforme.getSelectedItem().toString().equals("Prueba Entrada")) {
                try {
                    ...
                    ArrayList<String> pruebaEntrada = negNegocioPruebaEntrada.seleccionarPruebaEntrada(idInforme);
    ...
    //                idCargaAcedemicaMod = campo[11];
                ...
                try {
                    ...
                    ArrayList<String> informe = negoInfo.seleccionarInforCurso(idInforme);
...
//                FrmPrinicipal.escritorio.add(info);
                ...
                FrmPrinicipal.escritorio.add(info);
                info.IdInfoFinalCurso = idInforme;
                info.setVisible(true);
            }
            else if (cmbTipoInforme.getSelectedItem().toString().equals("Portafolio")) {
                try {
                    ClsNegocioPortafolio negoPorta = new ClsNegocioPortafolio();
                    ArrayList<String> informe = negoPorta.seleccionarInfoPortafolio(idInforme);
                    campo = informe.toArray(new String[informe.size()]);
                ...
                FrmPortafolio info = new FrmPortafolio(campo,false,nivelUsuario,codDocente);
                FrmPrinicipal.escritorio.add(info);
                info.IdPortafolio = idInforme;
                info.setVisible(true);
            }
        }        
    }
    ...
    private void buscarPruebaEntrada(String nivelUsuario,String codDocente){
     String tipoInforme = cmbTipoInforme.getSelectedItem().toString();
        if (tipoInforme.equals("Prueba Entrada")) {
            ...
            portafolio(nivelUsuario, codDocente);
        }
    }
    ...
    private void definirTituloTabla(String nivelUsuario) {
        ...
        case "Usuario":
            if (tipoInforme.equals("Portafolio")) {
                ...
                String titulosUsuario[] = {"ID","Cod Curso","Curso","Fecha","Estado","Unidad","Sección","Motivo"};
                dtm.setColumnIdentifiers(titulosUsuario);
            } else {
                String titulosUsuario[] = {"ID","Cod Curso","Curso","Fecha","Estado","Sección","Motivo"};
        ...
        case "Administrador":
            if (tipoInforme.equals("Portafolio")) {
                String titulosUsuario[] = {"ID","Cod Docente","Nombre","Semestre","Cod Curso","Curso","Fecha","Estado","Unidad","Sección","Motivo"};
                dtm.setColumnIdentifiers(titulosUsuario);
            } else {
            String titulosAdministrador[] = {"ID","Cod Docente","Nombre","Semestre","Cod Curso","Curso","Fecha","Estado","Sección","Motivo"};
...
//        JOptionPane.showMessageDialog(null, criterio);
    ...
    private void portafolio(String nivelUsuario,String codDocente){
        ...
        case "Administrador":
            ...
            while (rs.next()) {
                ...
                Campo[8] = (String) rs.getString(9); 
                Campo[9] = (String) rs.getString(10); 
                Campo[10] = (String) rs.getString(11); 
