...
public class FrmPrinicipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Semestre");
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem3ActionPerformed(evt);
            }
        });
        mnuMante.add(jMenuItem3);

        jMenuItem4.setText("Plan Estudios");
...
//        repo.setVisible(true);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        FrmCRUDSemestre form = new FrmCRUDSemestre();
        escritorio.add(form);
        form.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        FrmCRUDPlanEstudio form = new FrmCRUDPlanEstudio();
        escritorio.add(form);
        form.setVisible(true);
